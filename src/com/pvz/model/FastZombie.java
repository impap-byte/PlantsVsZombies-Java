...
public class FastZombie extends Zombie{
	...
	public FastZombie(int x_pos, int y_pos) {
		super(x_pos, y_pos);
	}
	...
	public void draw(Graphics g) {
		if (isDead) {
			...
			g.drawImage(type.getSprite()[currentFrame], x_pos, y_pos - 55, 160, 160, null);
		}
		//g.fillOval(x_pos + 40, y_pos, 10, 10); Zombinin gerçek konumu

	}

	@Override
	public ZombieType getType() {
		return ZombieType.FAST_ZOMBIE;
	}
	@Override
	public void update() {
		if (isDead) {
	    ...
	    currentCol = (x_pos + 35 - GamePanel.START_X + GamePanel.TILE_WIDTH / 2) / GamePanel.TILE_WIDTH;
